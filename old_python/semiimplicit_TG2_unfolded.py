...
pl.figure()
pl.plot(a,Gmag1,'k')
pl.plot(2*pl.pi+a[0:101],Gmag2[0:101],'r')
pl.plot(-2*pl.pi+a[101:],Gmag2[101:],'r')
pl.xlabel('kh')
pl.ylabel('|G|')

pl.figure()
pl.plot(a,Garg1,'k')
pl.plot(2*pl.pi+a[0:101],Garg2[0:101],'r')
pl.plot(-2*pl.pi+a[101:],Garg2[101:],'r')
pl.plot(a*2,argExact*2,'b')
pl.xlabel('kh')
pl.ylabel('arg(G)')
pl.show()
